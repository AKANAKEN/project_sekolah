        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                ...
                <div>
                   ...
                   <h1 style="text-align: center;">View Jadwal</h1>
                            ...
                            <tbody>
                                <?php foreach ($jadwal as $jadwal1) { ?>
                                    <tr align="center">
                                        ...
                                        <td><a href="<?php echo base_url('index.php/Dashboard/schedule_edit_tabel/' . $jadwal1->id_jadwal); ?>">Edit Jadwal |</a>
                                        <a href="<?php echo base_url('index.php/Schedule_data/delete/' . $jadwal1->id_jadwal); ?>">| Hapus</a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
