            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="dashboard/class_tabel">Data Kelas</a>
                            <a class="nav-link" href="dashboard/class_input_tabel">Input Data</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseLayouts_guru" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion_guru">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="dashboard/class_teacher">Data Guru</a>
                            <a class="nav-link" href="dashboard/class_input_teacher">Input Data</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseLayouts_room" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion_room">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="dashboard/room_data">Data Ruangan</a>
                            <a class="nav-link" href="dashboard/room_input_data">Input Data</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseLayouts_study" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion_study">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="dashboard/study_data">Data Mata Pelajaran</a>
                            <a class="nav-link" href="dashboard/study_input_data">Input Data</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseLayouts_schedule" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion_schedule">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="dashboard/schedule_data">Data Jadwal Pelajaran</a>
                            <a class="nav-link" href="dashboard/schedule_input">Input Data</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseLayouts_student" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion_student">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="dashboard/student_data">Data Siswa</a>
                            <a class="nav-link" href="dashboard/student_input">Input Data</a>
                        </nav>
                    </div>
