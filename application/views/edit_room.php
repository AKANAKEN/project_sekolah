    ...
    <main>
        <div class="container-fluid">
            <div class="card card-register mx-auto mt-5">
                <center><b>Form Edit Data Ruangan</b></center>
                <br>
                <div class="card-body">
                <form action="<?php echo base_url('index.php/Room_data/update'); ?>" method="post">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="kapasitas_ruangan" id="kapasitas_ruangan" class="form-control" value="<?php echo $ruangan->Kapasitas_ruangan; ?>"><br></td>
                        </tr>
